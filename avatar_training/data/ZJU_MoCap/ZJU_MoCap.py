...
class ZJU_MoCap(torch.utils.data.Dataset):
    ...
    def __init__(self, transform, data_split):
        ...
        self.root_path = osp.join('..', 'data', 'ZJU_MoCap', 'data', cfg.subject_id)
    ...
    def load_generated_data(self):
        ...
        gen_idx_list = []
        root_path = osp.join('..', 'data', 'ZJU_MoCap', 'data', cfg.subject_id + '_gen')
    ...
    def __getitem__(self, idx):
        ...
        data = {'img': img, 'mask': mask, 'bbox': bbox, 'cam_param': cam_param, 'frame_idx': frame_idx,
                'source': self.source_flag.get(frame_idx, 0)} 
        return data
