...
def parse_args():
    ...
    parser.add_argument('--frame_id', type=int, dest='frame_id', default=0) # reference frame for the time-conditioned rgb residual
...
def main():
    ...
    smplx_param = {'root_pose': torch.FloatTensor([math.pi,0,0]).cuda(), \
                ...
                'frame_id': torch.FloatTensor([args.frame_id]).cuda()} # time input of the rgb residual heads
