...
tmp_root = osp.join(root_path, 'flame_init')
os.makedirs(tmp_root, exist_ok=True)
output_save_path = tempfile.mkdtemp(prefix='deca_tmp_', dir=tmp_root)
...
# cleanup temp folder
shutil.rmtree(output_save_path, ignore_errors=True)
