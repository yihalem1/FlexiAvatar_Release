...
# path (per-subject temp dir to allow parallel runs)
base_tmp = osp.join(root_path, 'colmap_tmp')
os.makedirs(base_tmp, exist_ok=True)
colmap_path = tempfile.mkdtemp(prefix='run_', dir=base_tmp)
...
shutil.rmtree(colmap_path, ignore_errors=True)
